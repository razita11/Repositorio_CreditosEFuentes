...
namespace Gestion_Creditos_EFuentes.Clases
{
    internal class ConexionAccess
    {
        ...
        public static string cadena_conexion = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\DataSistema\CONFIGURACIONCREDITOS.accdb;Jet OLEDB:Database Password=RAZIta11;";
