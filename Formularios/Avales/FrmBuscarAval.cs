...
{
    public partial class FrmBuscarAval : Form
    {
        Clases.Auth auth = new Clases.Auth();
        Clases.DB db = new Clases.DB();
        Clases.Helpers h = new Clases.Helpers();

        public FrmBuscarAval()
        {
            InitializeComponent();
        }
        ...
        private void DgvData_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if(DgvData.Rows.Count > 0)
            {
                ...
                editar.RecibirDatosAvales(dni, nombre, apellidos, direccion, telefono, genero, fecha_n, correo);
                this.Close();
        ...
        private void FrmBuscarAval_Load(object sender, EventArgs e)
        {
            ListarAvales();
        }
