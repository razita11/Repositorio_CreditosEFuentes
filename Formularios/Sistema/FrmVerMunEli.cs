...
{
    public partial class FrmVerMunEli : Form
    {
        ...
        private void ListarMuni(string codigo = "")
        {
            ...
            string condicion = "MUNICIPIOS.ESTADO = 'I'";
        ...
        private void FrmVerMunEli_Load(object sender, EventArgs e)
        {
            ListarMuni();
        }
        ...
        private void DgvData_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (DgvData.Rows.Count > 0)
            {
                ...
                Editar.RecibirDatosElimMuni(codigo, municipio, estado, departamento);
                this.Close();
            }
        }
