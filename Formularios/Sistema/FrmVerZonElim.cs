...
{
    public partial class FrmVerZonElim : Form
    {
        Clases.DB db = new Clases.DB();
        Clases.Helpers h = new Clases.Helpers();
        public FrmVerZonElim()
        {
            InitializeComponent();
        }
        ...
        {
            DataTable zonas;
            string condicion = "ZONAS.ESTADO = 'I'";
        ...
        private void DgvData_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (DgvData.Rows.Count > 0)
            {
                ...
                Editar.RecibirDatosElimZona(codigo, zona, estado, departamento, municipio);
                this.Close();
            }
        }

        private void FrmVerZonElim_Load(object sender, EventArgs e)
        {
            ListarZonas();
        }
