...
{
    public partial class FrmVerRolElim : Form
    {
        Clases.DB db = new Clases.DB();
        Clases.Helpers h = new Clases.Helpers();
        public FrmVerRolElim()
        {
            InitializeComponent();
        }
        ...
        private void FrmVerRolElim_Load(object sender, EventArgs e)
        {
            ListarRoles();
        }
        ...
        private void DgvData_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (DgvData.Rows.Count > 0)
            {
                ...
                Editar.RecibirDatosRolElim(id, rol, estado);
                this.Close();
            }
        }
    }
