...
{
    public partial class FrmBuscarElimRequi : Form
    {
        Clases.DB db = new Clases.DB();
        Clases.Helpers h = new Clases.Helpers();
        public FrmBuscarElimRequi()
        {
            InitializeComponent();
        }
        ...
        private void FrmBuscarElimRequi_Load(object sender, EventArgs e)
        {
            listarDocs();
        }
        ...
        private void DgvData_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (DgvData.Rows.Count > 0)
            {
                ...
                Editar.RecibirDatosElimDoc(codigo, documento, oblig, estado);
                this.Close();
            }
        }
